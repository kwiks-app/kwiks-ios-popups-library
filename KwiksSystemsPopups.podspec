Pod::Spec.new do |s|
  ...
  s.version          = '0.1.5'
  s.summary          = 'KwiksSystemsPopups was designed to handle all internal card style popups in the Kwiks iOS Application - now with the option to customize the popup copy.'
  ...
  s.source           = { :git => 'https://github.com/kwiks-app/kwiks-ios-popups-library.git', :tag => s.version.to_s }
